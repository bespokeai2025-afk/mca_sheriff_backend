...
export const getfaq = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response = await faqservice.getfaq(req.verifyUser, parseInt(pageSize as string) || 50, parseInt(currentPage as string) || 1);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
...
export const getfaqById = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response = await faqservice.findfaqById(req.query.id as string, req.verifyUser);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
        const response = errorWithData("something went wrong", { error: error });
        return res.status(response.result ? 200 : 400).json(response);
...
export const createfaq = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response = await faqservice.createfaq(data, req.verifyUser);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
        const response = errorWithData("something went wrong", { error: error });
        return res.status(response.result ? 200 : 400).json(response);
...
export const updatefaq = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response: any = await faqservice.updatefaq(req.params.id, data, req.verifyUser);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
        const response = errorWithData("something went wrong", { error: error });
        return res.status(response.result ? 200 : 400).json(response);
...
export const deletefaq = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response = await faqservice.deletefaq(req.params.id, req.verifyUser);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
        const response = errorWithData("something went wrong", { error: error });
        return res.status(response.result ? 200 : 400).json(response);
...
export const activefaq = async (req: Request, res: Response): Promise<any> => {
    ...
    try {
        ...
        const response = await faqservice.activefaq(req.params.id, req.verifyUser);
        return res.status(response.result ? 200 : 400).json(response);
    } catch (error) {
        const response = errorWithData("something went wrong", { error: error });
        return res.status(response.result ? 200 : 400).json(response);
