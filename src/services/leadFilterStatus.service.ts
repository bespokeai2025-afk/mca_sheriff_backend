...
//   /**
//    * Ensure statuses exist: auto-fill if table is empty
//    */
//   async ensureStatusesExist(): Promise<void> {
//     const count = await this.leadFilterStatusRepository.count({
//       where: { isDeleted: false },
//     });

//     if (count === 0) {
//       console.log("⚙️ lead_filter_status table empty — fetching from Dynamics...");
//       await this.saveStatusesToDB();
//       console.log("✅ lead_filter_status table seeded successfully.");
//     }
//   }
// }
