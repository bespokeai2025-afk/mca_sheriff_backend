...
@Entity({ name: 'tomorrow_events' })
export class TomorrowEvent extends Common {
     @ManyToOne(() => User, user => user.id, { onDelete: 'CASCADE',nullable: true  })
        ...
        @ManyToOne(() => NotificationType, notificationType => notificationType.id, { onDelete: 'CASCADE', nullable: true })
        ...
        // // Relationship with OTPVerification entity
        // @OneToMany(() => PushNotification, (pushNotifications) => pushNotifications.notification)
