...
export class PushNotification extends Common {

    // @ManyToOne(() => User, user => user.pushNotifications, { onDelete: 'CASCADE' })
    // @JoinColumn({ name: 'user_id' })
    // user: User;

    // @ManyToOne(() => Notification, notification => notification.pushNotifications, { onDelete: 'CASCADE' })
